...
export const KAKAO_AUTH_URL = `https://kauth.kakao.com/oauth/authorize?client_id=4bd2c0bb8e2837b6462633a0ab8a7728&redirect_uri=${API_URL}${KAKAO_CALLBACK_URL}callback&response_type=code`;
